            ...
            <>
              <div className="flex gap-[18px] 2xl:gap-6 items-center">
                <div className="flex gap-[18px] 2xl:gap-6 items-center basis-1/2">
                  ...
                  <Radio name="type" value="Factory" onChange={() => setType(0)}/>
                  <Radio name="type" value="Vendor" onChange={() => setType(1)}/>
                  <Radio name="type" value="Shipping" onChange={() => setType(2)}/>
                </div>
                <div className="flex gap-[18px] 2xl:gap-6 items-center basis-1/2">
                </div>
              </div>
