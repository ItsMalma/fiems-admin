      ...
      <form>
        <div className="flex flex-col gap-3">
          ...
          <div className="flex gap-6 items-center justify-between">
            ...
            <InputText className="basis-2/3" placeholder="" disabled />
          </div>
          <div className="flex gap-6 items-center justify-between">
            <Label name="SKU Code" />
            <InputText className="basis-2/3" placeholder="Enter SKU code" />
          </div>
          {type == 0 && (
            <>
              <div className="flex gap-6 items-center justify-between">
          ...
          {type == 2 && (
            <>
              <div className="flex gap-6 items-center justify-between">
                <Label name="ATK Name" />
                <InputText className="basis-2/3" placeholder="Enter atk name" />
              </div>
            </>
          )}
        </div>
      ...
      <div className="flex flex-col p-[18px] 2xl:p-6 bg-white rounded-2xl shadow-sm gap-[18px] 2xl:gap-6 grow overflow-auto">
        ...
        <Table
          fields={[
            ...
            { type: "text", name: "Sparepart Name", isSortable: true },
            { type: "text", name: "Satuan", isSortable: true },
          ]}
          records={[
            [false, new Date(), "No. Reff", "Sparepart Name", "Pcs"],
            [false, new Date(), "No. Reff", "Sparepart Name", "Pack"],
            [false, new Date(), "No. Reff", "Sparepart Name", "Liter"],
          ]}
        />
