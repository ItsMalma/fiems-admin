                ...
                <div className="flex gap-[18px] 2xl:gap-6 items-center basis-1/2">
                    ...
                    <input
                      ...
                      onChange={() => {
                        if (detail.includes(0)) {
                          setDetail(detail.filter((item) => item !== 0));
                        } else {
                          setDetail([...detail, 0]);
                        }
                      }}
                  ...
                  <div className="flex">
                    <input
                      ...
                      className=""
                      onChange={() => {
                        if (detail.includes(1)) {
                          setDetail(detail.filter((item) => item !== 1));
                        } else {
                          setDetail([...detail, 1]);
                        }
                      }}
                ...
                <>
                  ...
                  <div className="flex gap-[18px] 2xl:gap-6 items-center">
                    <div className="flex gap-[18px] 2xl:gap-6 items-center basis-1/2">
                      ...
                      <InputText
                        placeholder="Enter dangerous goods class"
                        className="basis-3/5"
                      />
                    </div>
                    <div className="flex gap-[18px] 2xl:gap-6 items-center basis-1/2">
